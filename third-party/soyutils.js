...
// Codekid: Comment out goog.DEBUG def as it collides with base.js in
// uncompressed mode.
// goog.DEBUG = false;
...
if (!goog.userAgent) {
  goog.userAgent = (function () {
    ...
    return {
      jscript: {
        // Codekid: changed 'this' to 'window'.
        /**
         * @type {boolean}
         */
        HAS_JSCRIPT: "ScriptEngine" in window,
      },
      /**
       * @type {boolean}
       */
...
soy.$$stripHtmlTags = function (value, opt_tagWhitelist) {
  ...
  html = html.replace(soy.esc.$$HTML_TAG_REGEX_, function (tok, tagName) {
    if (tagName) {
      ...
      if (
        opt_tagWhitelist.hasOwnProperty(tagName) &&
