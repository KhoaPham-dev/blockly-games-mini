...
BlocklyGames.soy.headerBar = function (opt_data, opt_ignored, opt_ijData) {
  return (
    ...
    (opt_data.hasLinkButton
      ? '&nbsp;<button id="linkButton" title="Salveaz\u0103 \u0219i adaug\u0103 la blocuri. "><img src="common/1x1.gif" class="link icon21"></button>'
      : "") +
    (opt_data.hasHelpButton
      ? '&nbsp;<button id="helpButton">Ajutor</button>'
      : "") +
