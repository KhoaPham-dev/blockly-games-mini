...
BlocklyGames.soy.headerBar = function (opt_data, opt_ignored, opt_ijData) {
  return (
    ...
    (opt_data.hasLinkButton
      ? '&nbsp;<button id="linkButton" title="Saglab\u0101t un izveidot saiti uz blokiem."><img src="common/1x1.gif" class="link icon21"></button>'
      : "") +
    (opt_data.hasHelpButton
      ? '&nbsp;<button id="helpButton">Pal\u012Bdz\u012Bba</button>'
      : "") +
